...
*	Checks if a chunk is a buffer via duck-typing. (Note that chunks emitted from a readable stream are not considered `buffers` by the browserify-buffer module due to `instanceof chunk !== Buffer`, despite a chunk being a Buffer. To address this, duck type based on known `buffer` methods.)
*
* @private
