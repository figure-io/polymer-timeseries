...
(function() {
	...
	*/
	...
	Polymer( 'polymer-chart-timeseries', {
		/**
		* ATTRIBUTE: config
		...
		*/
		configChanged: function( oldConfig, newConfig ) {
			var err;
		...
		*/
		xValueChanged: function( oldVal, newVal ) {
			var err;
		...
		* @param {Function} newVal - new value
		*/
		yValueChanged: function( oldVal, newVal ) {
			var err;
			if ( typeof newVal !== 'function' ) {
				this.yValue = oldVal;
		...
		* @param {Function} newVal - new value
		*/
		isDefinedChanged: function( oldVal, newVal ) {
		...
		* @param {Number} newVal - new value
		*/
		labelsChanged: function( oldVal, newVal ) {
			var err;
		...
		* @param {Number} newVal - new value
		*/
		chartTitleChanged: function( oldVal, newVal ) {
			var err;
		...
		* @param {Number} newVal - new value
		*/
		xLabelChanged: function( oldVal, newVal ) {
			var err;
			if ( typeof newVal !== 'string' ) {
				this.xLabel = oldVal;
		...
		* @param {Number} newVal - new value
		*/
		yLabelChanged: function( oldVal, newVal ) {
			var err;
			if ( typeof newVal !== 'string' ) {
				this.yLabel = oldVal;
		...
		*/
		xMinChanged: function( oldVal, newVal ) {
		...
		* @param {Null|Number} newVal - new value
		*/
		xMaxChanged: function( oldVal, newVal ) {
			var xScale = this._xScale,
				domain = xScale.domain(),
				err;
		...
		* @param {Null|Number} newVal - new value
		*/
		yMinChanged: function( oldVal, newVal ) {
		...
		* @param {Null|Number} newVal - new value
		*/
		yMaxChanged: function( oldVal, newVal ) {
			var yScale = this._yScale,
				domain = yScale.domain(),
				err;
		...
		* @param {Number} newVal - new value
		*/
		xNumTicksChanged: function( oldVal, newVal ) {
		...
		* @param {Number} newVal - new value
		*/
		yNumTicksChanged: function( oldVal, newVal ) {
		...
		* @param {Number} newVal - new value
		*/
		xAxisOrientChanged: function( oldVal, newVal ) {
			var selection = this.$.xAxis,
				xAxis = this._xAxis,
				err;
		...
		* @param {Number} newVal - new value
		*/
		yAxisOrientChanged: function( oldVal, newVal ) {
			var selection = this.$.yAxis,
				yAxis = this._yAxis,
				err;
		...
		* @param {Number} newVal - new value
		*/
		xTickFormatChanged: function( oldVal, newVal ) {
			var selection = this.$.xAxis,
				xAxis = this._xAxis,
				err;
		...
		*/
		interpolationChanged: function( oldVal, newVal ) {
			var selection = this.$.paths,
				line = this._line,
				err;
		...
		* @param {Number} newVal - new value
		*/
		tensionChanged: function( oldVal, newVal ) {
			var selection = this.$.paths,
				line = this._line,
				err;
		...
		*/
		colorsChanged: function( oldVal, newVal ) {
			var err;
			if ( !Array.isArray( newVal ) ) {
				this.colors = oldVal;
		...
		* @param {Number} newVal - new value
		*/
		paddingLeftChanged: function( oldVal, newVal ) {
			var width,
				range,
				err;
		...
		* @param {Number} newVal - new value
		*/
		paddingRightChanged: function( oldVal, newVal ) {
			var width,
				range,
				err;
		...
		* @param {Number} newVal - new value
		*/
		paddingBottomChanged: function( oldVal, newVal ) {
			var height,
				range,
				err;
		...
		* @param {Number} newVal - new value
		*/
		paddingTopChanged: function( oldVal, newVal ) {
			var height,
				range,
				err;
